...

{
    ...
    if (emitter_->pointsCat10Smr.length() != 0) {
        for (WGS84Coordinates coord : emitter_->pointsCat10Smr) {
            ...
            this->ui->detailsMap->AddCircleMarker(coord,10,CustomMap::CAT10SMR,QString::number(i),"","","",400);
            i++;
        }
    ...
    if (emitter_->pointsCat10Mlat.length() != 0) {
        for (WGS84Coordinates coord : emitter_->pointsCat10Mlat) {
            ...
            this->ui->detailsMap->AddCircleMarker(coord,10,CustomMap::CAT10MLAT,QString::number(i),"","","",400);
            i++;
        }
    ...
    if (emitter_->pointsCat20.length() != 0) {
        for (WGS84Coordinates coord : emitter_->pointsCat20) {
            ...
            this->ui->detailsMap->AddCircleMarker(coord,10,CustomMap::CAT20,QString::number(i),"","","",400);
            i++;
        }
    ...
    if (emitter_->pointsCat21.length() != 0) {
        for (WGS84Coordinates coord : emitter_->pointsCat21) {
            ...
            this->ui->detailsMap->AddCircleMarker(coord,10,CustomMap::CAT21,QString::number(i),"","","",400);
            i++;
        }
